...
DEFAULT_RESULT_ROOT = ROOT / "results" / "ppi_embeddings"
DEFAULT_EDGE_FILE = ROOT / "data" / "ppi" / "hippie_highconf_edges.csv"
DEFAULT_RAW_FILE = ROOT / "data" / "ppi" / "raw" / "HIPPIE-current.mitab.txt"
DEFAULT_TARGET_GENE_FILE = ROOT / "task_dataset" / "processed" / "alzheimer_multiclass" / "X.csv"
